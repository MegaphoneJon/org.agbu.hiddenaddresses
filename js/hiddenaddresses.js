...
CRM.$(function($) {
    $('div.crm-contact-page').each(function() {
        $("<div class='crm-clear crm-summary-row'><div class='crm-content'><input type='checkbox' name='hiddenAddresses' id='show-hide-address'><span class='crm-content'>No Hidden Old Address(es).</span><div>").insertBefore($('div.crm-address-block div.add-new'));
        ...
        if (hiddenAddresses > 0) {
            ...
            checkbox.show();
            checkbox.next().show();
            checkbox.next().text(" Show " + hiddenAddresses + " Hidden Old Address(es).")
        }
    });
